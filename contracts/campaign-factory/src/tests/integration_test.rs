...
mod tests {
    ...
    mod execute_proper_operation {
        use crate::{
            ...
            tests::{
                env_setup::env::{instantiate_contracts, ADMIN, USER_1, USER_2, USER_3},
        ...
        fn proper_operation() {
            ...
            // query campaign contract address
            let campaign_info: CampaignInfo = app
                .wrap()
                .query_wasm_smart(
            ...
            assert_eq!(
                ...
                NftInfo {
                    ...
                    time_calc: start_time_1,
                    end_time: start_time_1 + 10
                }
            );

            // nft staked with USER_1
            let staked: StakerRewardAssetInfo = app
                .wrap()
                .query_wasm_smart(
                    "contract3",
            ...
            // reward rates
            let reward_rates: Vec<RewardRate> = app
                .wrap()
                .query_wasm_smart(
                    "contract3",
                    &CampaignQueryMsg::TermRewardRates { term_value: 10 },
                )
                .unwrap();
        ...
        fn proper_operation_with_multiple_users() {
            ...
            assert_eq!(
                ...
                NftInfo {
                    ...
                    owner: Addr::unchecked(USER_2.to_string()),
                    pending_reward: Uint128::from(52500u128),
                    lockup_term: LockupTerm {
                        value: 30,
                        percent: Uint128::from(70u128)
                    },
        ...
        fn proper_operation_with_multiple_users_2() {
            ...
            // mint 5 nft with token_id = 11..15 to USER_3
            for id in 11..15 {
                // mint nft
                let mint_nft_msg = Cw721MintMsg {
                    token_id: id.to_string(),
            ...
            for id in 11..15 {
                ...
                // Execute approve nft
                let response = app.execute_contract(
                    Addr::unchecked(USER_3.to_string()),
                    Addr::unchecked(collection_contract.clone()),
                    &approve_msg,
                    &[],
                );
            ...
            assert_eq!(
                ...
                NftInfo {
                    ...
                    lockup_term: LockupTerm {
                        value: 30,
                        percent: Uint128::from(100u128)
                    },
                    is_end_reward: false,
                    start_time: start_time_1,
                    time_calc: start_time_1 + 10,
                    end_time: start_time_1 + 30
                }
            );
            ...
            assert_eq!(
                ...
                NftInfo {
                    ...
                    token_id: "1".to_string(),
                    owner: Addr::unchecked(USER_1.to_string()),
                    pending_reward: Uint128::from(166666u128),
                    lockup_term: LockupTerm {
                        value: 30,
                        percent: Uint128::from(100u128)
                    },
            ...
            assert_eq!(
                ...
                NftInfo {
                    ...
                    token_id: "2".to_string(),
                    owner: Addr::unchecked(USER_1.to_string()),
                    pending_reward: Uint128::from(66666u128),
                    lockup_term: LockupTerm {
                        value: 30,
                        percent: Uint128::from(100u128)
                    },
            ...
            assert_eq!(
                ...
                NftInfo {
                    ...
                    token_id: "2".to_string(),
                    owner: Addr::unchecked(USER_1.to_string()),
                    pending_reward: Uint128::from(116666u128),
                    lockup_term: LockupTerm {
                        value: 30,
                        percent: Uint128::from(100u128)
                    },
            ...
            // USER_1 claim reward msg
            let claim_reward_msg = CampaignExecuteMsg::ClaimReward {
                amount: Uint128::from(283332u128),
            };
            ...
            assert_eq!(
                ...
                StakerRewardAssetInfo {
                    ...
                    reward_debt: Uint128::from(0u128),
                    reward_claimed: Uint128::from(283332u128),
                },
            );

            // increase 30 second
            app.set_block(BlockInfo {
                time: app.block_info().time.plus_seconds(30),
                height: app.block_info().height + 30,
                chain_id: app.block_info().chain_id,
            });
            ...
            let _start_time_7 = app.block_info().time.seconds();
            ...
            // stake nft token_id 11
            let stake_nft_msg = CampaignExecuteMsg::StakeNfts {
                stake_info: NftStake {
                    token_ids: vec!["11".to_string()],
                    lockup_term: 30,
                },
            };
            let _start_time_11 = app.block_info().time.seconds();
            ...
            // nft staked with USER_3
            let staked: StakerRewardAssetInfo = app
                .wrap()
                .query_wasm_smart(
                    "contract3",
                    &CampaignQueryMsg::NftStaked {
                        owner: Addr::unchecked(USER_3.to_string()),
                    },
                )
                .unwrap();
            ...
            assert_eq!(
                ...
                StakerRewardAssetInfo {
                    keys: vec![],
                    reward_debt: Uint128::from(266666u128),
                    reward_claimed: Uint128::zero()
                },
            );
            ...
            // USER_2 = 266666, USER_3 = 50000
            assert_eq!(total_pending_reward, Uint128::from(316668u128));

            // withdraw remaining reward msg = 1000000 - 283332 - 316668 = 400000
            let withdraw_reward_msg = CampaignExecuteMsg::WithdrawReward {};
            ...
            assert_eq!(
                ...
                CampaignInfo {
                    ...
                    total_reward_claimed: Uint128::from(283332u128),
                    total_reward: Uint128::from(1000000u128),
                    reward_per_second: Uint128::from(10000u128),
                    start_time: current_block_time + 10,
                    end_time: current_block_time + 110,
            ...
            // It should be 555000 token as withdraw happened
            assert_eq!(balance.balance, Uint128::from(400000u128));
            ...
            assert_eq!(balance.balance, Uint128::from(316668u128));
        }
        ...
        fn wrong_operation() {
            ...
            let stake_nft_msg = CampaignExecuteMsg::StakeNfts {
                stake_info: NftStake {
                    token_ids: vec!["3".to_string(), "4".to_string()],
                    lockup_term: 10,
                },
            };
            let _start_time_3 = app.block_info().time.seconds();
            ...
            // err with current reward = 30_000 but claim 200_000
            assert!(response.is_err());
        ...
        fn wrong_operation_add_reward() {
            ...
            let balance: BalanceResponse = app
                ...
                .unwrap();
            // It should be 1000 lp token as minting happened
            assert_eq!(balance.balance, Uint128::from(2 * MOCK_1000_TOKEN_AMOUNT));
        ...
        // ----------------- proper_operation_with_update_stake -----------------
        // 1. Mint 1000token -> ADMIN
        // 2. Mint 1,2,...,5 -> USER1
        // 3. Mint 6,7,...,10 -> USER2
        // 4. Mint 10,11,...,15 -> USER3
        // 5. Approve -> ALL
        // 6. Time = 0
        // 7. Create campaign: 10 -> 110
        // 		    term: 30
        // 		    max: 8
        // 		    limit: 4
        // 		    reward: 10.000
        ...
        // 11. Stake nft 1 -> ok
        // 12. Stake nft 2 -> ok
        // 	stake nft 11,12,..,14 -> ok
        // 	stake nft 6 -> err max 6
        // 13. Un stake nft 2 -> ok
        // 	stake nft 15 -> err limit 4
        // 	stake nft 6 -> ok
        // 14. Time = 30
        // 15. Approve + stake nft 2 -> ok
        // 16. Nft 1: reward = 200.000
        // 17. Nft 2: reward = 0
        // 18. Stake nft 6 -> ok
        // 19. Time = 50
        // 20. Nft 1: reward = 200.000(20s) + 10.000 * 10s / 3(1,2,6) = 233.333 -> end
        // 21. Nft 2: reward = 10.000 * 10s / 3(1,2,6) + 10.000 * 10s / 2(2,6) = 83.333
        // 22. Nft 6: reward = nft 2 = 83.333
        // 23. Time = 60
        // 24. Nft 1: reward = 233.333
        // 25. Nft 2: reward = 83.333 + 10.000 * 10s / 2(2,6) = 133.333 -> end
        // 26. Nft 6: reward = nft 2 = 133.333 -> end
        // 27. Total reward USER1 = 233.333 + 133.333 = 366.666
        // 28. USER1 claim 283.332, remaining = 83.334
        // 29. Time = 90
        // 30. Stake nft 7 -> ok
        // 31. Time = 100
        // 32. Stake nft 11 -> ok
        // 33. Time = 110
        // 34. Nft 7: reward = 10.000 * 10s / 1(7) + 10.000 * 10s / 2(7,11) = 150.000 -> end
        // 35. Nft 11: reward = 10.000 * 10s / 2(7,11) = 50.000 -> end
        // 36. Unstake nft 1, nft 2, nft 6, nft 7, nft 11
        // 37. USER1 reward = 83.334, claimed = 283.332
        // 38. USER2 reward = 133.333 + 150.000 = 283.333
        // 39. USER3 reward = 50.000
        // 40. Total pending = 416.668
        // 41. ADMIN token = 300.000

        #[test]
        fn proper_operation_with_update_stake() {
            // get integration test app and contracts
            let (mut app, contracts) = instantiate_contracts();
            ...
            // Stake before campaign active with PO live deposit reward
            // stake nft token_id 1
            let stake_nft_msg = CampaignExecuteMsg::StakeNfts {
                stake_info: NftStake {
                    token_ids: vec!["1".to_string()],
            ...
            // UnStake before campaign active
            // USER_1 un stake nft 2 msg
            let un_stake_nft_msg = CampaignExecuteMsg::UnStakeNft {
                un_stakes: vec![NftUnStake {
                    key: 2,
            ...
            // stake nft token_id 15
            let stake_nft_msg = CampaignExecuteMsg::StakeNfts {
                stake_info: NftStake {
                    token_ids: vec!["15".to_string()],
                    lockup_term: 30,
                },
            };
            ...
            // USER_3 un stake nft 13 msg
            let un_stake_nft_msg = CampaignExecuteMsg::UnStakeNft {
                un_stakes: vec![NftUnStake {
                    key: 5,
                    token_id: 13.to_string(),
                    lockup_term: 30,
                }],
            };
            ...
            // USER_3 un stake nft 14 msg
            let un_stake_nft_msg = CampaignExecuteMsg::UnStakeNft {
                un_stakes: vec![NftUnStake {
                    key: 6,
                    token_id: 14.to_string(),
                    lockup_term: 30,
                }],
            };
            ...
            // increase 25 second to make active campaign
            app.set_block(BlockInfo {
            ...
            assert_eq!(
                ...
                NftInfo {
                    ...
                    token_id: "1".to_string(),
                    owner: Addr::unchecked(USER_1.to_string()),
                    pending_reward: Uint128::from(200000u128),
                    lockup_term: LockupTerm {
                        value: 30,
                        percent: Uint128::from(100u128)
                    },
                    is_end_reward: false,
                    start_time: current_block_time + 10,
                    time_calc: current_block_time + 30,
                    end_time: current_block_time + 40
                }
            );
            ...
            // Approve nft 6 to campaign contract
            let approve_msg: Cw721ExecuteMsg = Cw721ExecuteMsg::Approve {
                spender: "contract3".to_string(), // Campaign Contract
                token_id: 6.to_string(),
                expires: None,
            ...
            assert_eq!(
                ...
                NftInfo {
                    ...
                    token_id: "1".to_string(),
                    owner: Addr::unchecked(USER_1.to_string()),
                    pending_reward: Uint128::from(233333u128),
                    lockup_term: LockupTerm {
                        value: 30,
                        percent: Uint128::from(100u128)
                    },
                    is_end_reward: true,
                    start_time: current_block_time + 10,
                    time_calc: current_block_time + 40,
                    end_time: current_block_time + 40
                }
            );
            ...
            let total: u64 = app
                .wrap()
                .query_wasm_smart("contract3", &CampaignQueryMsg::TotalNfts {})
                .unwrap();
            ...
            assert_eq!(
                ...
                NftInfo {
                    ...
                    token_id: "2".to_string(),
                    owner: Addr::unchecked(USER_1.to_string()),
                    pending_reward: Uint128::from(83333u128),
                    lockup_term: LockupTerm {
                        value: 30,
                        percent: Uint128::from(100u128)
                    },
            ...
            assert_eq!(
                ...
                NftInfo {
                    ...
                    token_id: "2".to_string(),
                    owner: Addr::unchecked(USER_1.to_string()),
                    pending_reward: Uint128::from(133333u128),
                    lockup_term: LockupTerm {
                        value: 30,
                        percent: Uint128::from(100u128)
                    },
            ...
            assert_eq!(
                ...
                StakerRewardAssetInfo {
                    ...
                    reward_debt: Uint128::from(83334u128),
                    reward_claimed: Uint128::from(283332u128),
                },
            );
            ...
            // Approve nft 11 to campaign contract
            let approve_msg: Cw721ExecuteMsg = Cw721ExecuteMsg::Approve {
                spender: "contract3".to_string(), // Campaign Contract
                token_id: 11.to_string(),
                expires: None,
            ...
            let start_time_11 = app.block_info().time.seconds();
            ...
            assert_eq!(
                ...
                NftInfo {
                    ...
                    token_id: "7".to_string(),
                    owner: Addr::unchecked(USER_2.to_string()),
                    pending_reward: Uint128::from(150000u128),
                    lockup_term: LockupTerm {
                        value: 30,
                        percent: Uint128::from(100u128)
                    },
            ...
            assert_eq!(
                ...
                NftInfo {
                    ...
                    token_id: "11".to_string(),
                    owner: Addr::unchecked(USER_3.to_string()),
                    pending_reward: Uint128::from(50000u128),
                    lockup_term: LockupTerm {
                        value: 30,
                        percent: Uint128::from(100u128)
                    },
                    is_end_reward: true,
                    start_time: start_time_11,
                    time_calc: start_time_11 + 10,
                    end_time: start_time_11 + 30
                }
            );
            ...
            assert_eq!(
                ...
                StakerRewardAssetInfo {
                    keys: vec![],
                    reward_debt: Uint128::from(283333u128),
                    reward_claimed: Uint128::zero()
                },
            );
            ...
            // USER_1 = 83334, USER_2 = 283333, USER_3 = 50000
            // but calc in rates then +1
            assert_eq!(total_pending_reward, Uint128::from(416668u128));

            // withdraw remaining reward msg = 1000000 - 283332 - 416668 = 300000
            let withdraw_reward_msg = CampaignExecuteMsg::WithdrawReward {};
            ...
            assert_eq!(
                ...
                CampaignInfo {
                    ...
                    reward_token: AssetToken {
                        info: token_info,
                        amount: Uint128::from(416668u128),
                    },
                    allowed_collection: Addr::unchecked(collection_contract.clone()),
                    lockup_term: vec![LockupTerm {
                        value: 30,
            ...
            // It should be 555000 token as withdraw happened
            assert_eq!(balance.balance, Uint128::from(300000u128));
            ...
            assert_eq!(balance.balance, Uint128::from(416668u128));
        }
    }
}
